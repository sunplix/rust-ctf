<template>
  <section class="page-block">
    <header class="page-head">
      <div>
        <p class="soft mono">PROFILE</p>
        <h1>账户中心</h1>
        <p class="muted">维护个人资料、修改密码并审计登录记录。</p>
      </div>
    ...
    <div class="profile-grid">
      <section class="panel card">
        ...
        <form class="form-grid" @submit.prevent="handleUpdateProfile">
          ...
          <button class="btn" type="submit" :disabled="updatingProfile">
    ...
    <section class="panel card">
      <div class="row-between">
        <h2>登录历史</h2>
        <button class="btn-ghost" type="button" @click="loadHistory" :disabled="loadingHistory">
    ...
    <section class="panel card">
      ...
      <button class="btn-danger" type="button" @click="handleDeleteAccount" :disabled="deletingAccount">
