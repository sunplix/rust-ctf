<template>
  <section class="page-block">
    <div class="row-between">
      <div>
        <h1>管理控制台</h1>
        <p class="muted">题目管理、比赛控制、实例监控、用户管理与审计日志。</p>
      </div>
    ...
    <div class="admin-layout">
      <aside class="panel admin-side-nav">
        <div class="admin-side-group">
          <p class="nav-group-label">核心模块</p>
          <button
            class="side-nav-btn"
            type="button"
        ...
        <div v-if="adminModule === 'challenges'" class="admin-side-group">
          <p class="nav-group-label">题目子导航</p>
          <button
        ...
        <div v-if="adminModule === 'contests'" class="admin-side-group">
          <p class="nav-group-label">比赛子导航</p>
          <button
            class="side-nav-btn side-sub-btn"
            type="button"
        ...
        <div v-if="adminModule === 'operations'" class="admin-side-group">
          <p class="nav-group-label">监控子导航</p>
          <button
            class="side-nav-btn side-sub-btn"
            type="button"
        ...
        <tbody>
          <tr v-for="item in users" :key="item.id">
            ...
            <td>
              ...
              >
                {{ selectedUserId === item.id ? "收起操作" : "管理该账号" }}
              </button>
